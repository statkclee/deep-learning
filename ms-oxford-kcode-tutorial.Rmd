...
``` {r dl-read-raw-image, warn=FALSE, message=FALSE}
library(dplyr)
library(ggplot2)
...
``` {r dl-image-location, warn=FALSE, message=FALSE}
## 1. Lena 이미지
...
``` {r dl-image-emotion, warn=FALSE, message=FALSE}
## 00. 환경설정  ========================================================================================== 
library("httr")
library("XML")
library("ggplot2")
...
``` {r dl-image-age, warn=FALSE, message=FALSE}
# 0. 환경설정--------------------------------------------------
library(httr)
library(XML)
library(ggplot2)
