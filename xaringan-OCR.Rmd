...
output:
  xaringan::moon_reader:
    ...
    css: ["default", "xaringan-themer.css", "xaringan_libs/remark.css"]
...
options(
  htmltools.dir.version = FALSE, tibble.width = 60, tibble.print_min = 6, crayon.enabled = TRUE
)
opts_chunk$set(
